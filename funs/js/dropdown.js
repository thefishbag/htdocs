(function($){
	$.fn.setIndex = function(options){
		...
		this.each(function(){
			...
			curEle.find("i").removeClass("fa-angle-up").addClass("fa-angle-down");
		});
	}
	$.fn.dropdown = function(options){
		...
		this.each(function(){
			...
			// 	curEle.find(".dlContent").hide();
			// 	curEle.find("i").removeClass("fa-angle-up").addClass("fa-angle-down");
			// 	curEle.find(".dlTitle").attr("openFlag","false");
			// });
			...
			$(this).find("h3").append('<i class="fa fa-angle-down"></i>');
			...
			$(this).find("h3").click(function(){
				...
				if (openFlag == "true") {
					...
					parentEle.find("i").removeClass("fa-angle-up").addClass("fa-angle-down");
					parentEle.find(".dlTitle").attr("openFlag","false");
				}else{
					
					$(".dl").find(".dlContent").hide();
					$(".dl").find("i").removeClass("fa-angle-up").addClass("fa-angle-down");
					$(".dl").find(".dlTitle").attr("openFlag","false");
					

					parentEle.find(".dlContent").show();
					parentEle.find("i").removeClass("fa-angle-down").addClass("fa-angle-up");
